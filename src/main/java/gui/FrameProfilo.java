...
public class FrameProfilo extends JFrame {
    ...
    private void updateBiglietti() {
        ...
        if(controller.getEtaPasseggero()>=16){
            ...
            controller.retrieveBigliettiInteri(controller.getIdUtente(),true,importo_totale,Sovrapprezzo_tot,n_bagagli,veicolo,prenotazione,corsa);
            ...
            controller.retrieveBigliettiRidotti(controller.getIdUtente(),true,importo_totale,Sovrapprezzo_tot,n_bagagli,prenotazione,corsa,accompagnatore);
